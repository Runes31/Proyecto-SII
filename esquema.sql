...
CREATE TABLE ASIGNATURA (REFERENCIA VARCHAR NOT NULL, disc VARCHAR(31), CARACTER VARCHAR, CODIGO VARCHAR NOT NULL, CREDITOS INTEGER NOT NULL, CUATRIMESTRE VARCHAR, CURSO INTEGER, DURACION INTEGER, IDIOMAS VARCHAR, NOMBRE VARCHAR NOT NULL, OFERTADA BOOLEAN NOT NULL, TITULACION_CODIGO VARCHAR NOT NULL, MENCION VARCHAR, PLAZAS INTEGER NOT NULL, PRIMARY KEY (REFERENCIA))
