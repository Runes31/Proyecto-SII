...
CREATE TABLE ASIGNATURA (REFERENCIA VARCHAR NOT NULL, CARACTER VARCHAR, CODIGO VARCHAR NOT NULL, CREDITOS INTEGER NOT NULL, CUATRIMESTRE VARCHAR, CURSO INTEGER, DURACION INTEGER, IDIOMAS VARCHAR, NOMBRE VARCHAR NOT NULL, OFERTADA BOOLEAN NOT NULL, TITULACION_CODIGO VARCHAR NOT NULL, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE CLASE (HORAINI TIME NOT NULL, DIA DATE NOT NULL, HORAFIN TIME, GRUPO_ID INTEGER NOT NULL, gruposPorAsignaturas_asignatura_fk VARCHAR NOT NULL, gruposPorAsignaturas_curso_fk VARCHAR NOT NULL, gruposPorAsignaturas_grupo_fk INTEGER NOT NULL, PRIMARY KEY (HORAINI, DIA, GRUPO_ID))
...
CREATE TABLE GRUPOSPORASIGNATURA (CURSOACADEMICO VARCHAR NOT NULL, OFERTA BOOLEAN, ASIGNATURA_REFERENCIA VARCHAR NOT NULL, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (CURSOACADEMICO, ASIGNATURA_REFERENCIA, GRUPO_ID))
...
CREATE TABLE ASIGNATURASMATRICULA (ASIGNATURA_REFERENCIA VARCHAR NOT NULL, GRUPO_ID INTEGER, EXPEDIENTE_NUMEXPEDIENTE INTEGER NOT NULL, CURSOACADEMICO VARCHAR NOT NULL, PRIMARY KEY (ASIGNATURA_REFERENCIA, EXPEDIENTE_NUMEXPEDIENTE, CURSOACADEMICO))
